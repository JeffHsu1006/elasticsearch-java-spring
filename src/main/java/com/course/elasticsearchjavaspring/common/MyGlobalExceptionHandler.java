...
public class MyGlobalExceptionHandler {
	...
	public ResponseEntity<ErrorResponse> handleInvalidApiParamException(IllegalApiParamException e) {
		var message = "Exception API Param from global exception handler, " + e.getMessage();
		LOG.warn(message);
